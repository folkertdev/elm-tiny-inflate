module Adler32 exposing (adler32) 
...
a32 = { base = 65521, nmax =   5552 } 

slice : Int -> Bytes -> List Bytes
slice maxSize buffer = 
    let go (remainingLength, accum)  = 
    ...
    let length = Bytes.width buffer 
        ...
        go ( i, s1, s2 ) =
            if i < length then
                ...
                let newS1 = s1 |> modBy a32.base 
                    newS2 =  s2 |> modBy a32.base 
                in
